...
def generate_launch_description() -> LaunchDescription:
    ...
    start_nav2 = IncludeLaunchDescription(
        launch_description_source=PythonLaunchDescriptionSource(launch_file_path=str(nav2_navigation_launch)),
        launch_arguments={
            "use_sim_time": LaunchConfiguration(variable_name="use_sim_time"),
            "autostart": LaunchConfiguration(variable_name="autostart"),
            "params_file": LaunchConfiguration(variable_name="params_file"),
            "use_composition": LaunchConfiguration(variable_name="use_composition"),
            "use_respawn": LaunchConfiguration(variable_name="use_respawn"),
            "log_level": LaunchConfiguration(variable_name="log_level"),
        }.items(),
    ...
    start_rviz = Node(
        ...
        parameters=[{"use_sim_time": LaunchConfiguration(variable_name="use_sim_time")}],
        condition=IfCondition(predicate_expression=LaunchConfiguration(variable_name="use_rviz")),
    )
